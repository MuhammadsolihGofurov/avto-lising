...
export default function Offcanvas() {
  ...
  const menu = [
    ...
    //   url: `/${router.locale}/products`,
    // },
    // {
    //   id: 4,
    //   title: intl.formatMessage({ id: "blogs" }),
    //   url: `/${router.locale}/blogs`,
    // },
    {
      id: 5,
    ...
    //   url: `/${router.locale}/projects`,
    // },
  ];

  return (
    <div
      className={`fixed top-0 left-0 w-full h-screen z-[999] bg-nav text-dark p-5 transition-transform duration-200 bg-white ${
