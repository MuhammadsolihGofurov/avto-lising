...
export default function ContactInfo() {
  const intl = useIntl();
  return (
    <section id="contact__info" className="py-10 md:py-20">
      <div className="container flex flex-col gap-10 sm:gap-20">
        ...
        >
          <SmallTitle>
            {intl.formatMessage({ id: "contactsInfoTitle" })}
          </SmallTitle>
          <h2 className="text-2xl sm:tex-3xl lg:text-4xl font-bold">
            {intl.formatMessage({ id: "contactsInfoBody" })}
          </h2>
        </div>
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 4xl:grid-cols-4 gap-5">
          <div
            className="w-full min-h-[400px] rounded-3xl relative z-0 after:w-full after:h-0 after:bottom-0 after:left-0 after:bg-main after:opacity-60 after:absolute after:z-[-1] hover:after:h-full after:transition-all after:duration-200 overflow-hidden flex justify-end flex-col p-5"
            style={{
              backgroundImage: `url(/images/location-img.jpg)`,
            ...
            data-aos-delay="100"
          >
            <div className="bg-white p-5 rounded-3xl flex flex-col gap-1 min-h-[120px]">
              <h3 className="font-semibold text-lg">
                {intl.formatMessage({ id: "ourAddress" })}
              </h3>
            ...
            {/* absolute */}
            <div className="absolute top-5 right-5 w-16 h-16 flex items-center justify-center bg-main rounded-xl">
              <svg
          ...
          <div
            className="w-full min-h-[400px] rounded-3xl relative z-0 after:w-full after:h-0 after:bottom-0 after:left-0 after:bg-main after:opacity-60 after:absolute after:z-[-1] hover:after:h-full after:transition-all after:duration-200 overflow-hidden flex justify-end flex-col p-5"
            style={{
              backgroundImage: `url(/images/email-img.jpg)`,
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
            data-aos="fade-up"
          ...
          >
            <div className="bg-white p-5 rounded-3xl flex flex-col gap-1 min-h-[120px]">
              <h3 className="font-semibold text-lg">
                {intl.formatMessage({ id: "ourEmail" })}
              </h3>
              <a
                href={`mailto: ${email}`}
          ...
          <div
            className="w-full min-h-[400px] rounded-3xl relative z-0 after:w-full after:h-0 after:bottom-0 after:left-0 after:bg-main after:opacity-60 after:absolute after:z-[-1] hover:after:h-full after:transition-all after:duration-200 overflow-hidden flex justify-end flex-col p-5"
            style={{
              backgroundImage: `url(/images/phone-img.jpg)`,
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
            data-aos="fade-up"
          ...
          >
            <div className="bg-white p-5 rounded-3xl flex flex-col gap-1 min-h-[120px]">
              <h3 className="font-semibold text-lg">
                {intl.formatMessage({ id: "ourPhone" })}
              </h3>
              <div>
                <a
          ...
          <div
            className="w-full min-h-[400px] rounded-3xl relative z-0 after:w-full after:h-0 after:bottom-0 after:left-0 after:bg-main after:opacity-60 after:absolute after:z-[-1] hover:after:h-full after:transition-all after:duration-200 overflow-hidden flex justify-end flex-col p-5"
            style={{
              backgroundImage: `url(/images/follow-img.jpg)`,
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
            data-aos="fade-up"
          ...
          >
            <div className="bg-white p-5 rounded-3xl flex flex-col gap-1 min-h-[120px]">
              <h3 className="font-semibold text-lg">
                {intl.formatMessage({ id: "ourFollow" })}
              </h3>
              <Socials />
            </div>
